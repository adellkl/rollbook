              ...
              {page === 'training' && (
                <>
                  <section className="stats-grid training-stats mt-8">
                    <article className="stat-card"><span className="stat-label">Cette semaine</span><div className="big-number">{weeklySessions.length}</div><small>séance{weeklySessions.length > 1 ? 's' : ''} enregistrée{weeklySessions.length > 1 ? 's' : ''}</small></article>
                    <article className="stat-card"><span className="stat-label">Volume</span><div className="big-number">{weeklyVolume}<span className="text-base"> min</span></div><small>objectif : 180 min</small></article>
                    <article className="stat-card"><span className="stat-label">Intensité moyenne</span><div className="big-number">{weeklyIntensity?.toFixed(1) ?? '—'}<span className="text-base"> /10</span></div><small>ressenti de la semaine</small></article>
                  </section>
